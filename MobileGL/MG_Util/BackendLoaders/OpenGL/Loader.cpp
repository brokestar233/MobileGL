...
#define INIT_GLES_FUNC(name)                                                                                           \
    do {                                                                                                               \
...

        {
            ...
            INIT_GLES_FUNC(glDrawArraysInstancedBaseInstance)
            INIT_GLES_FUNC(glDrawElementsInstancedBaseInstance)
            INIT_GLES_FUNC(glDrawElementsInstancedBaseVertexBaseInstance)
